...
import profilePic from "public/extraImages/profil1.jpeg";
    ...
    >
      ...
      <div className="px-0 md:px-8 lg:px-20 text-black dark:text-white">
        ...
        <p className="text-sm md:text-base lg:text-lg font-light md:px-7 pt-3 font-outfit">
          ...
          mahasiswa Ma'Soem university semester 4 program studi Sistem Informasi A.
          <br />
          <br />Saya memiliki ketertarikan untuk mempelajari{" "}
          <span className="text-blue-500 font-semibold">
            <a
          ...
          khusus nya mengembangkan kemampuan dalam bidang html css, next js dan lain sebagainya.
          <br /> <br /> Dan saat ini saya berkomitmen untuk terus mengeksplorasi dan mengasah kemampuan dalam bidang {" "}
          <span className="text-blue-500 font-semibold">
            perweweban seperti ini!
          </span>
        </p>
      </div>
    </motion.div>
